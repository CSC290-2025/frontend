...
import Sidebar from '@/features/_example/components/Sidebar';
import TopBar from '@/features/_example/components/Topbar';

const CityInsightsApp = () => {
...
export default CityInsightsApp;
