...
import { useWasteTypes, useLogWaste } from '../hooks';
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <Button
            ...
            className="h-11 w-full bg-gradient-to-r from-purple-600 to-pink-600 text-base hover:from-purple-700 hover:to-pink-700"
          >
