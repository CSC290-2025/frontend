  ...
  return (
    <div className="flex flex-col gap-[27px]">
      ...
      <div className="flex flex-col gap-[13px]">
        ...
        <div className="h-[50px] w-[332px] gap-[10px] rounded-[10px] border border-[#00000040] bg-[#FAFAFA] px-[16px] py-[13px] text-[16px]">
          {data.IdCardNumber}
        </div>
      </div>
      {/* Full Name */}
      <div className="flex gap-[27px]">
        ...
        <div className="flex flex-col">
          ...
          <input
            type="text"
            name="firstname"
            className="h-[50px] w-[194px] gap-[10px] rounded-[10px] border border-[#00000040] bg-[#FAFAFA] px-[16px] py-[13px] text-[16px]"
      ...
      <div className="flex flex-col">
        ...
        <div className="ml-[49px] flex gap-[27px]">
          ...
          <div>
            ...
            <div className="h-[50px] w-[167px] gap-[10px] rounded-[10px] border border-[#00000040] bg-[#FAFAFA] px-[16px] py-[13px] text-[16px]">
              {data.Enthnicity}
            </div>
          </div>
          {/* Nationality */}
          <div>
            ...
            <input
              type="text"
              name="nationality"
              className="h-[50px] w-[167px] gap-[10px] rounded-[10px] border border-[#00000040] bg-[#FAFAFA] px-[16px] py-[13px] text-[16px]"
        ...
        <div className="ml-[49px] flex gap-[27px]">
          ...
          <div>
            ...
            <input
              type="text"
              name="phoneNumber"
              className="h-[50px] w-[246px] gap-[10px] rounded-[10px] border border-[#00000040] bg-[#FAFAFA] px-[16px] py-[13px] text-[16px]"
        ...
        <div className="ml-[49px] flex flex-col gap-[27px]">
          <div>
            ...
            <input
              type="text"
              name="addressLine"
              className="h-[50px] w-[557px] gap-[10px] rounded-[10px] border border-[#00000040] bg-[#FAFAFA] px-[16px] py-[13px] text-[16px]"
          ...
          <div className="flex gap-[27px]">
            <div>
              ...
              <input
                type="text"
                name="subDistrict"
                className="h-[50px] w-[226px] gap-[10px] rounded-[10px] border border-[#00000040] bg-[#FAFAFA] px-[16px] py-[13px] text-[16px]"
