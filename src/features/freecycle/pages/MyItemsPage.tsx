          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-3 xl:grid-cols-4">
            {items.map((item) => (
              <div key={item.id} className="group relative">
                ...
                {/* ✅✅✅ ส่วนแสดงผลด้านซ้ายบน (Indicators) ✅✅✅ */}
                <div className="absolute top-2 left-2 z-10 flex flex-col items-start gap-1">
                  {/* 1. แสดงสถานะ Given Away (ถ้ามี) */}
                  {item.is_given && (
                  ...
                  {/* 2. แสดงจำนวน Request (ถ้ามีมากกว่า 0) */}
                  {/* เนื่องจากหน้านี้คือ MyItemsPage ดังนั้นคนเห็นคือเจ้าของแน่นอน */}
                ...
                {/* ACTION BUTTONS (ขวาบน เหมือนเดิม) */}
